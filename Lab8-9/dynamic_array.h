...
//    }
     ...
     */
    long long search(const value_type& value) const{
        long long i = 0;
        while(i < list_size){
...
//    long long search_if(std::function<int(const value_type)> condition) const{
//        long long i = 0;
//        while(i < list_size){
//            if(condition(*list[i]))
//                return i;
...
//    }
     ...
     * @return Position of value in array.
     */
    long long rsearch(const value_type& value) const{
